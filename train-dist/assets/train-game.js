...
`)+`
`+p);const E=M+m+a,b=M+p+o,w=wc(r,r.VERTEX_SHADER,E),y=wc(r,r.FRAGMENT_SHADER,b);r.attachShader(S,w),r.attachShader(S,y),t.index0AttributeName!==void 0?r.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function R(C){if(i.debug.checkShaderErrors){const F=r.getProgramInfoLog(S)||"",k=r.getShaderInfoLog(w)||"",W=r.getShaderInfoLog(y)||"",N=F.trim(),G=k.trim(),H=W.trim();let j=!0,Q=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,S,w,y);else{const le=Cc(r,w,"vertex"),xe=Cc(r,y,"fragment");We("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`

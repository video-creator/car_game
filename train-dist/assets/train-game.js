...
void main() {
	...
	`}class gc extends on{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Wo(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new Tt(5,5,5),s=new cn({name:"CubemapFromEquirect",uniforms:wi(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:ct,blending:mn});s.uniforms.tEquirect.value=t;const a=new Be(r,s),o=t.minFilter;return t.minFilter===Kn&&(t.minFilter=Rt),new Gh(1,10,this).update(e,a),t.minFilter=o,a.geometry.dispose(),a.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const s=e.getRenderTarget();for(let a=0;a<6;a++)e.setRenderTarget(this,a),e.clear(t,n,r);e.setRenderTarget(s)}}function id(i){let e=new WeakMap,t=new WeakMap,n=null;function r(h,p=!1){return h==null?null:p?a(h):s(h)}function s(h){if(h&&h.isTexture){const p=h.mapping;if(p===is||p===rs)if(e.has(h)){const x=e.get(h).texture;return o(x,h.mapping)}else{const x=h.image;if(x&&x.height>0){const b=new gc(x.height);return b.fromEquirectangularTexture(i,h),e.set(h,b),h.addEventListener("dispose",l),o(b.texture,h.mapping)}else return null}}return h}function a(h){if(h&&h.isTexture){const p=h.mapping,x=p===is||p===rs,b=p===Yn||p===li;if(x||b){let m=t.get(h);const d=m!==void 0?m.texture.pmremVersion:0;if(h.isRenderTargetTexture&&h.pmremVersion!==d)return n===null&&(n=new fc(i)),m=x?n.fromEquirectangular(h,m):n.fromCubemap(h,m),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),m.texture;if(m!==void 0)return m.texture;{const v=h.image;return x&&v&&v.height>0||b&&v&&c(v)?(n===null&&(n=new fc(i)),m=x?n.fromEquirectangular(h):n.fromCubemap(h),m.texture.pmremVersion=h.pmremVersion,t.set(h,m),h.addEventListener("dispose",u),m.texture):null}}}return h}function o(h,p){return p===is?h.mapping=Yn:p===rs&&(h.mapping=li),h}function c(h){let p=0;const x=6;for(let b=0;b<x;b++)h[b]!==void 0&&p++;return p===x}function l(h){const p=h.target;p.removeEventListener("dispose",l);const x=e.get(p);x!==void 0&&(e.delete(p),x.dispose())}function u(h){const p=h.target;p.removeEventListener("dispose",u);const x=t.get(p);x!==void 0&&(t.delete(p),x.dispose())}function f(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:f}}function rd(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=i.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Ys("WebGLRenderer: "+n+" extension not supported."),r}}}function sd(i,e,t,n){const r={},s=new WeakMap;function a(f){const h=f.target;h.index!==null&&e.remove(h.index);for(const x in h.attributes)e.remove(h.attributes[x]);h.removeEventListener("dispose",a),delete r[h.id];const p=s.get(h);p&&(e.remove(p),s.delete(h)),n.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function o(f,h){return r[h.id]===!0||(h.addEventListener("dispose",a),r[h.id]=!0,t.memory.geometries++),h}function c(f){const h=f.attributes;for(const p in h)e.update(h[p],i.ARRAY_BUFFER)}function l(f){const h=[],p=f.index,x=f.attributes.position;let b=0;if(x===void 0)return;if(p!==null){const v=p.array;b=p.version;for(let S=0,y=v.length;S<y;S+=3){const w=v[S+0],E=v[S+1],R=v[S+2];h.push(w,E,E,R,R,w)}}else{const v=x.array;b=x.version;for(let S=0,y=v.length/3-1;S<y;S+=3){const w=S+0,E=S+1,R=S+2;h.push(w,E,E,R,R,w)}}const m=new(x.count>=65535?Fo:No)(h,1);m.version=b;const d=s.get(f);d&&e.remove(d),s.set(f,m)}function u(f){const h=s.get(f);if(h){const p=f.index;p!==null&&h.version<p.version&&l(f)}else l(f);return s.get(f)}return{get:o,update:c,getWireframeAttribute:u}}function ad(i,e,t){let n;function r(f){n=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function c(f,h){i.drawElements(n,h,s,f*a),t.update(h,n,1)}function l(f,h,p){p!==0&&(i.drawElementsInstanced(n,h,s,f*a,p),t.update(h,n,p))}function u(f,h,p){if(p===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,h,0,s,f,0,p);let b=0;for(let m=0;m<p;m++)b+=h[m];t.update(b,n,1)}this.setMode=r,this.setIndex=o,this.render=c,this.renderInstances=l,this.renderMultiDraw=u}function od(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(s/3);break;case i.LINES:t.lines+=o*(s/2);break;case i.LINE_STRIP:t.lines+=o*(s-1);break;case i.LINE_LOOP:t.lines+=o*s;break;case i.POINTS:t.points+=o*s;break;default:We("WebGLInfo: Unknown draw mode:",a);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function cd(i,e,t){const n=new WeakMap,r=new lt;function s(a,o,c){const l=a.morphTargetInfluences,u=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,f=u!==void 0?u.length:0;let h=n.get(o);if(h===void 0||h.count!==f){let A=function(){R.dispose(),n.delete(o),o.removeEventListener("dispose",A)};h!==void 0&&h.texture.dispose();const p=o.morphAttributes.position!==void 0,x=o.morphAttributes.normal!==void 0,b=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],d=o.morphAttributes.normal||[],v=o.morphAttributes.color||[];let S=0;p===!0&&(S=1),x===!0&&(S=2),b===!0&&(S=3);let y=o.attributes.position.count*S,w=1;y>e.maxTextureSize&&(w=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);const E=new Float32Array(y*w*4*f),R=new bo(E,y,w,f);R.type=$t,R.needsUpdate=!0;const g=S*4;for(let L=0;L<f;L++){const C=m[L],F=d[L],k=v[L],W=y*w*4*L;for(let N=0;N<C.count;N++){const G=N*g;p===!0&&(r.fromBufferAttribute(C,N),E[W+G+0]=r.x,E[W+G+1]=r.y,E[W+G+2]=r.z,E[W+G+3]=0),x===!0&&(r.fromBufferAttribute(F,N),E[W+G+4]=r.x,E[W+G+5]=r.y,E[W+G+6]=r.z,E[W+G+7]=0),b===!0&&(r.fromBufferAttribute(k,N),E[W+G+8]=r.x,E[W+G+9]=r.y,E[W+G+10]=r.z,E[W+G+11]=k.itemSize===4?r.w:1)}}h={count:f,texture:R,size:new be(y,w)},n.set(o,h),o.addEventListener("dispose",A)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)c.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let p=0;for(let b=0;b<l.length;b++)p+=l[b];const x=o.morphTargetsRelative?1:1-p;c.getUniforms().setValue(i,"morphTargetBaseInfluence",x),c.getUniforms().setValue(i,"morphTargetInfluences",l)}c.getUniforms().setValue(i,"morphTargetsTexture",h.texture,t),c.getUniforms().setValue(i,"morphTargetsTextureSize",h.size)}return{update:s}}function ld(i,e,t,n,r){let s=new WeakMap;function a(l){const u=r.render.frame,f=l.geometry,h=e.get(l,f);if(s.get(h)!==u&&(e.update(h),s.set(h,u)),l.isInstancedMesh&&(l.hasEventListener("dispose",c)===!1&&l.addEventListener("dispose",c),s.get(l)!==u&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,u))),l.isSkinnedMesh){const p=l.skeleton;s.get(p)!==u&&(p.update(),s.set(p,u))}return h}function o(){s=new WeakMap}function c(l){const u=l.target;u.removeEventListener("dispose",c),n.releaseStatesOfObject(u),t.remove(u.instanceMatrix),u.instanceColor!==null&&t.remove(u.instanceColor)}return{update:a,dispose:o}}const hd={[to]:"LINEAR_TONE_MAPPING",[no]:"REINHARD_TONE_MAPPING",[io]:"CINEON_TONE_MAPPING",[ns]:"ACES_FILMIC_TONE_MAPPING",[so]:"AGX_TONE_MAPPING",[ao]:"NEUTRAL_TONE_MAPPING",[ro]:"CUSTOM_TONE_MAPPING"};function ud(i,e,t,n,r){const s=new on(e,t,{type:i,depthBuffer:n,stencilBuffer:r,depthTexture:n?new Ti(e,t):void 0}),a=new on(e,t,{type:_n,depthBuffer:!1,stencilBuffer:!1}),o=new Ut;o.setAttribute("position",new st([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new st([0,2,0,0,2,0],2));const c=new Ih({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
...
`].filter(Ji).join(`
`)),a=za(a),a=Pc(a,t),a=Lc(a,t),o=za(o),o=Pc(o,t),o=Lc(o,t),a=Dc(a),o=Dc(o),t.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
`)+`
`+d);const S=v+m+a,y=v+d+o,w=wc(r,r.VERTEX_SHADER,S),E=wc(r,r.FRAGMENT_SHADER,y);r.attachShader(b,w),r.attachShader(b,E),t.index0AttributeName!==void 0?r.bindAttribLocation(b,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(b,0,"position"),r.linkProgram(b);function R(C){if(i.debug.checkShaderErrors){const F=r.getProgramInfoLog(b)||"",k=r.getShaderInfoLog(w)||"",W=r.getShaderInfoLog(E)||"",N=F.trim(),G=k.trim(),H=W.trim();let j=!0,Q=!0;if(r.getProgramParameter(b,r.LINK_STATUS)===!1)if(j=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,b,w,E);else{const le=Cc(r,w,"vertex"),xe=Cc(r,E,"fragment");We("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(b,r.VALIDATE_STATUS)+`
...
}`;class jp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new Xo(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new cn({vertexShader:Jp,fragmentShader:Zp,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Be(new Ki(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Qp extends Zn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,u=null,f=null,h=null,p=null,x=null;const b=typeof XRWebGLBinding!="undefined",m=new jp,d={},v=t.getContextAttributes();let S=null,y=null;const w=[],E=[],R=new be;let g=null;const A=new Yt;A.viewport=new lt;const L=new Yt;L.viewport=new lt;const C=[A,L],F=new Vh;let k=null,W=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function($){let fe=w[$];return fe===void 0&&(fe=new ia,w[$]=fe),fe.getTargetRaySpace()},this.getControllerGrip=function($){let fe=w[$];return fe===void 0&&(fe=new ia,w[$]=fe),fe.getGripSpace()},this.getHand=function($){let fe=w[$];return fe===void 0&&(fe=new ia,w[$]=fe),fe.getHandSpace()};function N($){const fe=E.indexOf($.inputSource);if(fe===-1)return;const ie=w[fe];ie!==void 0&&(ie.update($.inputSource,$.frame,l||a),ie.dispatchEvent({type:$.type,data:$.inputSource}))}function G(){r.removeEventListener("select",N),r.removeEventListener("selectstart",N),r.removeEventListener("selectend",N),r.removeEventListener("squeeze",N),r.removeEventListener("squeezestart",N),r.removeEventListener("squeezeend",N),r.removeEventListener("end",G),r.removeEventListener("inputsourceschange",H);for(let $=0;$<w.length;$++){const fe=E[$];fe!==null&&(E[$]=null,w[$].disconnect(fe))}k=null,W=null,m.reset();for(const $ in d)delete d[$];e.setRenderTarget(S),p=null,h=null,f=null,r=null,y=null,Ie.stop(),n.isPresenting=!1,e.setPixelRatio(g),e.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function($){s=$,n.isPresenting===!0&&Te("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function($){o=$,n.isPresenting===!0&&Te("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function($){l=$},this.getBaseLayer=function(){return h!==null?h:p},this.getBinding=function(){return f===null&&b&&(f=new XRWebGLBinding(r,t)),f},this.getFrame=function(){return x},this.getSession=function(){return r},this.setSession=function($){return Za(this,null,function*(){if(r=$,r!==null){if(S=e.getRenderTarget(),r.addEventListener("select",N),r.addEventListener("selectstart",N),r.addEventListener("selectend",N),r.addEventListener("squeeze",N),r.addEventListener("squeezestart",N),r.addEventListener("squeezeend",N),r.addEventListener("end",G),r.addEventListener("inputsourceschange",H),v.xrCompatible!==!0&&(yield t.makeXRCompatible()),g=e.getPixelRatio(),e.getSize(R),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let ie=null,Ae=null,Pe=null;v.depth&&(Pe=v.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ie=v.stencil?$n:xn,Ae=v.stencil?Ni:sn);const we={colorFormat:t.RGBA8,depthFormat:Pe,scaleFactor:s};f=this.getBinding(),h=f.createProjectionLayer(we),r.updateRenderState({layers:[h]}),e.setPixelRatio(1),e.setSize(h.textureWidth,h.textureHeight,!1),y=new on(h.textureWidth,h.textureHeight,{format:Jt,type:Bt,depthTexture:new Ti(h.textureWidth,h.textureHeight,Ae,void 0,void 0,void 0,void 0,void 0,void 0,ie),stencilBuffer:v.stencil,colorSpace:e.outputColorSpace,samples:v.antialias?4:0,resolveDepthBuffer:h.ignoreDepthValues===!1,resolveStencilBuffer:h.ignoreDepthValues===!1})}else{const ie={antialias:v.antialias,alpha:!0,depth:v.depth,stencil:v.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,ie),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),y=new on(p.framebufferWidth,p.framebufferHeight,{format:Jt,type:Bt,colorSpace:e.outputColorSpace,stencilBuffer:v.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}y.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=yield r.requestReferenceSpace(o),Ie.setContext(r),Ie.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}})},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function H($){for(let fe=0;fe<$.removed.length;fe++){const ie=$.removed[fe],Ae=E.indexOf(ie);Ae>=0&&(E[Ae]=null,w[Ae].disconnect(ie))}for(let fe=0;fe<$.added.length;fe++){const ie=$.added[fe];let Ae=E.indexOf(ie);if(Ae===-1){for(let we=0;we<w.length;we++)if(we>=E.length){E.push(ie),Ae=we;break}else if(E[we]===null){E[we]=ie,Ae=we;break}if(Ae===-1)break}const Pe=w[Ae];Pe&&Pe.connect(ie)}}const j=new P,Q=new P;function le($,fe,ie){j.setFromMatrixPosition(fe.matrixWorld),Q.setFromMatrixPosition(ie.matrixWorld);const Ae=j.distanceTo(Q),Pe=fe.projectionMatrix.elements,we=ie.projectionMatrix.elements,at=Pe[14]/(Pe[10]-1),Ve=Pe[14]/(Pe[10]+1),Je=(Pe[9]+1)/Pe[5],rt=(Pe[9]-1)/Pe[5],ze=(Pe[8]-1)/Pe[0],vt=(we[8]+1)/we[0],ot=at*ze,Ht=at*vt,I=Ae/(-ze+vt),Mt=I*-ze;if(fe.matrixWorld.decompose($.position,$.quaternion,$.scale),$.translateX(Mt),$.translateZ(I),$.matrixWorld.compose($.position,$.quaternion,$.scale),$.matrixWorldInverse.copy($.matrixWorld).invert(),Pe[10]===-1)$.projectionMatrix.copy(fe.projectionMatrix),$.projectionMatrixInverse.copy(fe.projectionMatrixInverse);else{const He=at+I,nt=Ve+I,ce=ot-Mt,ut=Ht+(Ae-Mt),T=Je*Ve/nt*He,_=rt*Ve/nt*He;$.projectionMatrix.makePerspective(ce,ut,T,_,He,nt),$.projectionMatrixInverse.copy($.projectionMatrix).invert()}}function xe($,fe){fe===null?$.matrixWorld.copy($.matrix):$.matrixWorld.multiplyMatrices(fe.matrixWorld,$.matrix),$.matrixWorldInverse.copy($.matrixWorld).invert()}this.updateCamera=function($){if(r===null)return;let fe=$.near,ie=$.far;m.texture!==null&&(m.depthNear>0&&(fe=m.depthNear),m.depthFar>0&&(ie=m.depthFar)),F.near=L.near=A.near=fe,F.far=L.far=A.far=ie,(k!==F.near||W!==F.far)&&(r.updateRenderState({depthNear:F.near,depthFar:F.far}),k=F.near,W=F.far),F.layers.mask=$.layers.mask|6,A.layers.mask=F.layers.mask&-5,L.layers.mask=F.layers.mask&-3;const Ae=$.parent,Pe=F.cameras;xe(F,Ae);for(let we=0;we<Pe.length;we++)xe(Pe[we],Ae);Pe.length===2?le(F,A,L):F.projectionMatrix.copy(A.projectionMatrix),Ee($,F,Ae)};function Ee($,fe,ie){ie===null?$.matrix.copy(fe.matrixWorld):($.matrix.copy(ie.matrixWorld),$.matrix.invert(),$.matrix.multiply(fe.matrixWorld)),$.matrix.decompose($.position,$.quaternion,$.scale),$.updateMatrixWorld(!0),$.projectionMatrix.copy(fe.projectionMatrix),$.projectionMatrixInverse.copy(fe.projectionMatrixInverse),$.isPerspectiveCamera&&($.fov=$s*2*Math.atan(1/$.projectionMatrix.elements[5]),$.zoom=1)}this.getCamera=function(){return F},this.getFoveation=function(){if(!(h===null&&p===null))return c},this.setFoveation=function($){c=$,h!==null&&(h.fixedFoveation=$),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=$)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(F)},this.getCameraTexture=function($){return d[$]};let Xe=null;function $e($,fe){if(u=fe.getViewerPose(l||a),x=fe,u!==null){const ie=u.views;p!==null&&(e.setRenderTargetFramebuffer(y,p.framebuffer),e.setRenderTarget(y));let Ae=!1;ie.length!==F.cameras.length&&(F.cameras.length=0,Ae=!0);for(let Ve=0;Ve<ie.length;Ve++){const Je=ie[Ve];let rt=null;if(p!==null)rt=p.getViewport(Je);else{const vt=f.getViewSubImage(h,Je);rt=vt.viewport,Ve===0&&(e.setRenderTargetTextures(y,vt.colorTexture,vt.depthStencilTexture),e.setRenderTarget(y))}let ze=C[Ve];ze===void 0&&(ze=new Yt,ze.layers.enable(Ve),ze.viewport=new lt,C[Ve]=ze),ze.matrix.fromArray(Je.transform.matrix),ze.matrix.decompose(ze.position,ze.quaternion,ze.scale),ze.projectionMatrix.fromArray(Je.projectionMatrix),ze.projectionMatrixInverse.copy(ze.projectionMatrix).invert(),ze.viewport.set(rt.x,rt.y,rt.width,rt.height),Ve===0&&(F.matrix.copy(ze.matrix),F.matrix.decompose(F.position,F.quaternion,F.scale)),Ae===!0&&F.cameras.push(ze)}const Pe=r.enabledFeatures;if(Pe&&Pe.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&b){f=n.getBinding();const Ve=f.getDepthInformation(ie[0]);Ve&&Ve.isValid&&Ve.texture&&m.init(Ve,r.renderState)}if(Pe&&Pe.includes("camera-access")&&b){e.state.unbindTexture(),f=n.getBinding();for(let Ve=0;Ve<ie.length;Ve++){const Je=ie[Ve].camera;if(Je){let rt=d[Je];rt||(rt=new Xo,d[Je]=rt);const ze=f.getCameraImage(Je);rt.sourceTexture=ze}}}}for(let ie=0;ie<w.length;ie++){const Ae=E[ie],Pe=w[ie];Ae!==null&&Pe!==void 0&&Pe.update(Ae,fe,l||a)}Xe&&Xe($,fe),fe.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:fe}),x=null}const Ie=new cc;Ie.setAnimationLoop($e),this.setAnimationLoop=function($){Xe=$},this.dispose=function(){}}}const em=new Qe,Bc=new Ce;Bc.set(-1,0,0,0,1,0,0,0,1);function tm(i,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,jo(i)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function r(m,d,v,S,y){d.isNodeMaterial?d.uniformsNeedUpdate=!1:d.isMeshBasicMaterial?s(m,d):d.isMeshLambertMaterial?(s(m,d),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)):d.isMeshToonMaterial?(s(m,d),f(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)):d.isMeshStandardMaterial?(s(m,d),h(m,d),d.isMeshPhysicalMaterial&&p(m,d,y)):d.isMeshMatcapMaterial?(s(m,d),x(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),b(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?c(m,d,v,S):d.isSpriteMaterial?l(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===ct&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===ct&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const v=e.get(d),S=v.envMap,y=v.envMapRotation;S&&(m.envMap.value=S,m.envMapRotation.value.setFromMatrix4(em.makeRotationFromEuler(y)).transpose(),S.isCubeTexture&&S.isRenderTargetTexture===!1&&m.envMapRotation.value.premultiply(Bc),m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function c(m,d,v,S){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*v,m.scale.value=S*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function l(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function f(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function h(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,v){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===ct&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=v.texture,m.transmissionSamplerSize.value.set(v.width,v.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function x(m,d){d.matcap&&(m.matcap.value=d.matcap)}function b(m,d){const v=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(v.matrixWorld),m.nearDistance.value=v.shadow.camera.near,m.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function nm(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(v,S){const y=S.program;n.uniformBlockBinding(v,y)}function l(v,S){let y=r[v.id];y===void 0&&(x(v),y=u(v),r[v.id]=y,v.addEventListener("dispose",m));const w=S.program;n.updateUBOMapping(v,w);const E=e.render.frame;s[v.id]!==E&&(h(v),s[v.id]=E)}function u(v){const S=f();v.__bindingPointIndex=S;const y=i.createBuffer(),w=v.__size,E=v.usage;return i.bindBuffer(i.UNIFORM_BUFFER,y),i.bufferData(i.UNIFORM_BUFFER,w,E),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,S,y),y}function f(){for(let v=0;v<o;v++)if(a.indexOf(v)===-1)return a.push(v),v;return We("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(v){const S=r[v.id],y=v.uniforms,w=v.__cache;i.bindBuffer(i.UNIFORM_BUFFER,S);for(let E=0,R=y.length;E<R;E++){const g=Array.isArray(y[E])?y[E]:[y[E]];for(let A=0,L=g.length;A<L;A++){const C=g[A];if(p(C,E,A,w)===!0){const F=C.__offset,k=Array.isArray(C.value)?C.value:[C.value];let W=0;for(let N=0;N<k.length;N++){const G=k[N],H=b(G);typeof G=="number"||typeof G=="boolean"?(C.__data[0]=G,i.bufferSubData(i.UNIFORM_BUFFER,F+W,C.__data)):G.isMatrix3?(C.__data[0]=G.elements[0],C.__data[1]=G.elements[1],C.__data[2]=G.elements[2],C.__data[3]=0,C.__data[4]=G.elements[3],C.__data[5]=G.elements[4],C.__data[6]=G.elements[5],C.__data[7]=0,C.__data[8]=G.elements[6],C.__data[9]=G.elements[7],C.__data[10]=G.elements[8],C.__data[11]=0):ArrayBuffer.isView(G)?C.__data.set(new G.constructor(G.buffer,G.byteOffset,C.__data.length)):(G.toArray(C.__data,W),W+=H.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,F,C.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function p(v,S,y,w){const E=v.value,R=S+"_"+y;if(w[R]===void 0)return typeof E=="number"||typeof E=="boolean"?w[R]=E:ArrayBuffer.isView(E)?w[R]=E.slice():w[R]=E.clone(),!0;{const g=w[R];if(typeof E=="number"||typeof E=="boolean"){if(g!==E)return w[R]=E,!0}else{if(ArrayBuffer.isView(E))return!0;if(g.equals(E)===!1)return g.copy(E),!0}}return!1}function x(v){const S=v.uniforms;let y=0;const w=16;for(let R=0,g=S.length;R<g;R++){const A=Array.isArray(S[R])?S[R]:[S[R]];for(let L=0,C=A.length;L<C;L++){const F=A[L],k=Array.isArray(F.value)?F.value:[F.value];for(let W=0,N=k.length;W<N;W++){const G=k[W],H=b(G),j=y%w,Q=j%H.boundary,le=j+Q;y+=Q,le!==0&&w-le<H.storage&&(y+=w-le),F.__data=new Float32Array(H.storage/Float32Array.BYTES_PER_ELEMENT),F.__offset=y,y+=H.storage}}}const E=y%w;return E>0&&(y+=w-E),v.__size=y,v.__cache={},this}function b(v){const S={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(S.boundary=4,S.storage=4):v.isVector2?(S.boundary=8,S.storage=8):v.isVector3||v.isColor?(S.boundary=16,S.storage=12):v.isVector4?(S.boundary=16,S.storage=16):v.isMatrix3?(S.boundary=48,S.storage=48):v.isMatrix4?(S.boundary=64,S.storage=64):v.isTexture?Te("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(v)?(S.boundary=16,S.storage=v.byteLength):Te("WebGLRenderer: Unsupported uniform value type.",v),S}function m(v){const S=v.target;S.removeEventListener("dispose",m);const y=a.indexOf(S.__bindingPointIndex);a.splice(y,1),i.deleteBuffer(r[S.id]),delete r[S.id],delete s[S.id]}function d(){for(const v in r)i.deleteBuffer(r[v]);a=[],r={},s={}}return{bind:c,update:l,dispose:d}}const im=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let un=null;function rm(){return un===null&&(un=new Go(im,16,16,Jn,_n),un.name="DFG_LUT",un.minFilter=Rt,un.magFilter=Rt,un.wrapS=gn,un.wrapT=gn,un.generateMipmaps=!1,un.needsUpdate=!0),un}class sm{constructor(e={}){const{canvas:t=zl(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:f=!1,reversedDepthBuffer:h=!1,outputBufferType:p=Bt}=e;this.isWebGLRenderer=!0;let x;if(n!==null){if(typeof WebGLRenderingContext!="undefined"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");x=n.getContextAttributes().alpha}else x=a;const b=p,m=new Set([ps,ds,fs]),d=new Set([Bt,sn,Ui,Ni,ls,hs]),v=new Uint32Array(4),S=new Int32Array(4),y=new P;let w=null,E=null;const R=[],g=[];let A=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=rn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const L=this;let C=!1,F=null;this._outputColorSpace=Xt;let k=0,W=0,N=null,G=-1,H=null;const j=new lt,Q=new lt;let le=null;const xe=new Ge(0);let Ee=0,Xe=t.width,$e=t.height,Ie=1,$=null,fe=null;const ie=new lt(0,0,Xe,$e),Ae=new lt(0,0,Xe,$e);let Pe=!1;const we=new Ea;let at=!1,Ve=!1;const Je=new Qe,rt=new P,ze=new lt,vt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ot=!1;function Ht(){return N===null?Ie:1}let I=n;function Mt(M,U){return t.getContext(M,U)}try{const M={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:f};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${Dt}`),t.addEventListener("webglcontextlost",J,!1),t.addEventListener("webglcontextrestored",Me,!1),t.addEventListener("webglcontextcreationerror",Le,!1),I===null){const U="webgl2";if(I=Mt(U,M),I===null)throw Mt(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(M){throw We("WebGLRenderer: "+M.message),M}let He,nt,ce,ut,T,_,O,Y,Z,ee,ae,X,K,de,ge,re,te,Re,Ue,Ye,D,ne,q;function pe(){He=new rd(I),He.init(),D=new $p(I,He),nt=new Jf(I,He,e,D),ce=new Yp(I,He),nt.reversedDepthBuffer&&h&&ce.buffers.depth.setReversed(!0),ut=new od(I),T=new Ip,_=new Kp(I,He,ce,T,nt,D,ut),O=new id(L),Y=new Wh(I),ne=new Kf(I,Y),Z=new sd(I,Y,ut,ne),ee=new ld(I,Z,Y,ne,ut),Re=new cd(I,nt,_),ge=new Zf(T),ae=new Dp(L,O,He,nt,ne,ge),X=new tm(L,T),K=new Np,de=new Vp(He),te=new Yf(L,O,ce,ee,x,c),re=new qp(L,ee,nt),q=new nm(I,ut,nt,ce),Ue=new $f(I,He,ut),Ye=new ad(I,He,ut),ut.programs=ae.programs,L.capabilities=nt,L.extensions=He,L.properties=T,L.renderLists=K,L.shadowMap=re,L.state=ce,L.info=ut}pe(),b!==Bt&&(A=new ud(b,t.width,t.height,r,s));const se=new Qp(L,I);this.xr=se,this.getContext=function(){return I},this.getContextAttributes=function(){return I.getContextAttributes()},this.forceContextLoss=function(){const M=He.get("WEBGL_lose_context");M&&M.loseContext()},this.forceContextRestore=function(){const M=He.get("WEBGL_lose_context");M&&M.restoreContext()},this.getPixelRatio=function(){return Ie},this.setPixelRatio=function(M){M!==void 0&&(Ie=M,this.setSize(Xe,$e,!1))},this.getSize=function(M){return M.set(Xe,$e)},this.setSize=function(M,U,V=!0){if(se.isPresenting){Te("WebGLRenderer: Can't change size while VR device is presenting.");return}Xe=M,$e=U,t.width=Math.floor(M*Ie),t.height=Math.floor(U*Ie),V===!0&&(t.style.width=M+"px",t.style.height=U+"px"),A!==null&&A.setSize(t.width,t.height),this.setViewport(0,0,M,U)},this.getDrawingBufferSize=function(M){return M.set(Xe*Ie,$e*Ie).floor()},this.setDrawingBufferSize=function(M,U,V){Xe=M,$e=U,Ie=V,t.width=Math.floor(M*V),t.height=Math.floor(U*V),this.setViewport(0,0,M,U)},this.setEffects=function(M){if(b===Bt){We("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(M){for(let U=0;U<M.length;U++)if(M[U].isOutputPass===!0){Te("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(M||[])},this.getCurrentViewport=function(M){return M.copy(j)},this.getViewport=function(M){return M.copy(ie)},this.setViewport=function(M,U,V,B){M.isVector4?ie.set(M.x,M.y,M.z,M.w):ie.set(M,U,V,B),ce.viewport(j.copy(ie).multiplyScalar(Ie).round())},this.getScissor=function(M){return M.copy(Ae)},this.setScissor=function(M,U,V,B){M.isVector4?Ae.set(M.x,M.y,M.z,M.w):Ae.set(M,U,V,B),ce.scissor(Q.copy(Ae).multiplyScalar(Ie).round())},this.getScissorTest=function(){return Pe},this.setScissorTest=function(M){ce.setScissorTest(Pe=M)},this.setOpaqueSort=function(M){$=M},this.setTransparentSort=function(M){fe=M},this.getClearColor=function(M){return M.copy(te.getClearColor())},this.setClearColor=function(){te.setClearColor(...arguments)},this.getClearAlpha=function(){return te.getClearAlpha()},this.setClearAlpha=function(){te.setClearAlpha(...arguments)},this.clear=function(M=!0,U=!0,V=!0){let B=0;if(M){let z=!1;if(N!==null){const ue=N.texture.format;z=m.has(ue)}if(z){const ue=N.texture.type,_e=d.has(ue),he=te.getClearColor(),ve=te.getClearAlpha(),Se=he.r,De=he.g,Fe=he.b;_e?(v[0]=Se,v[1]=De,v[2]=Fe,v[3]=ve,I.clearBufferuiv(I.COLOR,0,v)):(S[0]=Se,S[1]=De,S[2]=Fe,S[3]=ve,I.clearBufferiv(I.COLOR,0,S))}else B|=I.COLOR_BUFFER_BIT}U&&(B|=I.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),V&&(B|=I.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),B!==0&&I.clear(B)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(M){M.setRenderer(this),F=M},this.dispose=function(){t.removeEventListener("webglcontextlost",J,!1),t.removeEventListener("webglcontextrestored",Me,!1),t.removeEventListener("webglcontextcreationerror",Le,!1),te.dispose(),K.dispose(),de.dispose(),T.dispose(),O.dispose(),ee.dispose(),ne.dispose(),q.dispose(),ae.dispose(),se.dispose(),se.removeEventListener("sessionstart",Zc),se.removeEventListener("sessionend",jc),ai.stop()};function J(M){M.preventDefault(),vo("WebGLRenderer: Context Lost."),C=!0}function Me(){vo("WebGLRenderer: Context Restored."),C=!1;const M=ut.autoReset,U=re.enabled,V=re.autoUpdate,B=re.needsUpdate,z=re.type;pe(),ut.autoReset=M,re.enabled=U,re.autoUpdate=V,re.needsUpdate=B,re.type=z}function Le(M){We("WebGLRenderer: A WebGL context could not be created. Reason: ",M.statusMessage)}function dt(M){const U=M.target;U.removeEventListener("dispose",dt),Ze(U)}function Ze(M){Pn(M),T.remove(M)}function Pn(M){const U=T.get(M).programs;U!==void 0&&(U.forEach(function(V){ae.releaseProgram(V)}),M.isShaderMaterial&&ae.releaseShaderCache(M))}this.renderBufferDirect=function(M,U,V,B,z,ue){U===null&&(U=vt);const _e=z.isMesh&&z.matrixWorld.determinant()<0,he=Tm(M,U,V,B,z);ce.setMaterial(B,_e);let ve=V.index,Se=1;if(B.wireframe===!0){if(ve=Z.getWireframeAttribute(V),ve===void 0)return;Se=2}const De=V.drawRange,Fe=V.attributes.position;let ye=De.start*Se,je=(De.start+De.count)*Se;ue!==null&&(ye=Math.max(ye,ue.start*Se),je=Math.min(je,(ue.start+ue.count)*Se)),ve!==null?(ye=Math.max(ye,0),je=Math.min(je,ve.count)):Fe!=null&&(ye=Math.max(ye,0),je=Math.min(je,Fe.count));const pt=je-ye;if(pt<0||pt===1/0)return;ne.setup(z,B,he,V,ve);let ft,et=Ue;if(ve!==null&&(ft=Y.get(ve),et=Ye,et.setIndex(ft)),z.isMesh)B.wireframe===!0?(ce.setLineWidth(B.wireframeLinewidth*Ht()),et.setMode(I.LINES)):et.setMode(I.TRIANGLES);else if(z.isLine){let Lt=B.linewidth;Lt===void 0&&(Lt=1),ce.setLineWidth(Lt*Ht()),z.isLineSegments?et.setMode(I.LINES):z.isLineLoop?et.setMode(I.LINE_LOOP):et.setMode(I.LINE_STRIP)}else z.isPoints?et.setMode(I.POINTS):z.isSprite&&et.setMode(I.TRIANGLES);if(z.isBatchedMesh)if(He.get("WEBGL_multi_draw"))et.renderMultiDraw(z._multiDrawStarts,z._multiDrawCounts,z._multiDrawCount);else{const Lt=z._multiDrawStarts,me=z._multiDrawCounts,kt=z._multiDrawCount,qe=ve?Y.get(ve).bytesPerElement:1,Kt=T.get(B).currentProgram.getUniforms();for(let pn=0;pn<kt;pn++)Kt.setValue(I,"_gl_DrawID",pn),et.render(Lt[pn]/qe,me[pn])}else if(z.isInstancedMesh)et.renderInstances(ye,pt,z.count);else if(V.isInstancedBufferGeometry){const Lt=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,me=Math.min(V.instanceCount,Lt);et.renderInstances(ye,pt,me)}else et.render(ye,pt)};function dn(M,U,V){M.transparent===!0&&M.side===Ot&&M.forceSinglePass===!1?(M.side=ct,M.needsUpdate=!0,kr(M,U,V),M.side=Wt,M.needsUpdate=!0,kr(M,U,V),M.side=Ot):kr(M,U,V)}this.compile=function(M,U,V=null){V===null&&(V=M),E=de.get(V),E.init(U),g.push(E),V.traverseVisible(function(z){z.isLight&&z.layers.test(U.layers)&&(E.pushLight(z),z.castShadow&&E.pushShadow(z))}),M!==V&&M.traverseVisible(function(z){z.isLight&&z.layers.test(U.layers)&&(E.pushLight(z),z.castShadow&&E.pushShadow(z))}),E.setupLights();const B=new Set;return M.traverse(function(z){if(!(z.isMesh||z.isPoints||z.isLine||z.isSprite))return;const ue=z.material;if(ue)if(Array.isArray(ue))for(let _e=0;_e<ue.length;_e++){const he=ue[_e];dn(he,V,z),B.add(he)}else dn(ue,V,z),B.add(ue)}),E=g.pop(),B},this.compileAsync=function(M,U,V=null){const B=this.compile(M,U,V);return new Promise(z=>{function ue(){if(B.forEach(function(_e){T.get(_e).currentProgram.isReady()&&B.delete(_e)}),B.size===0){z(M);return}setTimeout(ue,10)}He.get("KHR_parallel_shader_compile")!==null?ue():setTimeout(ue,10)})};let $a=null;function ym(M){$a&&$a(M)}function Zc(){ai.stop()}function jc(){ai.start()}const ai=new cc;ai.setAnimationLoop(ym),typeof self!="undefined"&&ai.setContext(self),this.setAnimationLoop=function(M){$a=M,se.setAnimationLoop(M),M===null?ai.stop():ai.start()},se.addEventListener("sessionstart",Zc),se.addEventListener("sessionend",jc),this.render=function(M,U){if(U!==void 0&&U.isCamera!==!0){We("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(C===!0)return;F!==null&&F.renderStart(M,U);const V=se.enabled===!0&&se.isPresenting===!0,B=A!==null&&(N===null||V)&&A.begin(L,N);if(M.matrixWorldAutoUpdate===!0&&M.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),se.enabled===!0&&se.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(se.cameraAutoUpdate===!0&&se.updateCamera(U),U=se.getCamera()),M.isScene===!0&&M.onBeforeRender(L,M,U,N),E=de.get(M,g.length),E.init(U),E.state.textureUnits=_.getTextureUnits(),g.push(E),Je.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),we.setFromProjectionMatrix(Je,an,U.reversedDepth),Ve=this.localClippingEnabled,at=ge.init(this.clippingPlanes,Ve),w=K.get(M,R.length),w.init(),R.push(w),se.enabled===!0&&se.isPresenting===!0){const _e=L.xr.getDepthSensingMesh();_e!==null&&Ja(_e,U,-1/0,L.sortObjects)}Ja(M,U,0,L.sortObjects),w.finish(),L.sortObjects===!0&&w.sort($,fe),ot=se.enabled===!1||se.isPresenting===!1||se.hasDepthSensing()===!1,ot&&te.addToRenderList(w,M),this.info.render.frame++,at===!0&&ge.beginShadows();const z=E.state.shadowsArray;if(re.render(z,M,U),at===!0&&ge.endShadows(),this.info.autoReset===!0&&this.info.reset(),(B&&A.hasRenderPass())===!1){const _e=w.opaque,he=w.transmissive;if(E.setupLights(),U.isArrayCamera){const ve=U.cameras;if(he.length>0)for(let Se=0,De=ve.length;Se<De;Se++){const Fe=ve[Se];el(_e,he,M,Fe)}ot&&te.render(M);for(let Se=0,De=ve.length;Se<De;Se++){const Fe=ve[Se];Qc(w,M,Fe,Fe.viewport)}}else he.length>0&&el(_e,he,M,U),ot&&te.render(M),Qc(w,M,U)}N!==null&&W===0&&(_.updateMultisampleRenderTarget(N),_.updateRenderTargetMipmap(N)),B&&A.end(L),M.isScene===!0&&M.onAfterRender(L,M,U),ne.resetDefaultState(),G=-1,H=null,g.pop(),g.length>0?(E=g[g.length-1],_.setTextureUnits(E.state.textureUnits),at===!0&&ge.setGlobalState(L.clippingPlanes,E.state.camera)):E=null,R.pop(),R.length>0?w=R[R.length-1]:w=null,F!==null&&F.renderEnd()};function Ja(M,U,V,B){if(M.visible===!1)return;if(M.layers.test(U.layers)){if(M.isGroup)V=M.renderOrder;else if(M.isLOD)M.autoUpdate===!0&&M.update(U);else if(M.isLightProbeGrid)E.pushLightProbeGrid(M);else if(M.isLight)E.pushLight(M),M.castShadow&&E.pushShadow(M);else if(M.isSprite){if(!M.frustumCulled||we.intersectsSprite(M)){B&&ze.setFromMatrixPosition(M.matrixWorld).applyMatrix4(Je);const _e=ee.update(M),he=M.material;he.visible&&w.push(M,_e,he,V,ze.z,null)}}else if((M.isMesh||M.isLine||M.isPoints)&&(!M.frustumCulled||we.intersectsObject(M))){const _e=ee.update(M),he=M.material;if(B&&(M.boundingSphere!==void 0?(M.boundingSphere===null&&M.computeBoundingSphere(),ze.copy(M.boundingSphere.center)):(_e.boundingSphere===null&&_e.computeBoundingSphere(),ze.copy(_e.boundingSphere.center)),ze.applyMatrix4(M.matrixWorld).applyMatrix4(Je)),Array.isArray(he)){const ve=_e.groups;for(let Se=0,De=ve.length;Se<De;Se++){const Fe=ve[Se],ye=he[Fe.materialIndex];ye&&ye.visible&&w.push(M,_e,ye,V,ze.z,Fe)}}else he.visible&&w.push(M,_e,he,V,ze.z,null)}}const ue=M.children;for(let _e=0,he=ue.length;_e<he;_e++)Ja(ue[_e],U,V,B)}function Qc(M,U,V,B){const{opaque:z,transmissive:ue,transparent:_e}=M;E.setupLightsView(V),at===!0&&ge.setGlobalState(L.clippingPlanes,V),B&&ce.viewport(j.copy(B)),z.length>0&&Hr(z,U,V),ue.length>0&&Hr(ue,U,V),_e.length>0&&Hr(_e,U,V),ce.buffers.depth.setTest(!0),ce.buffers.depth.setMask(!0),ce.buffers.color.setMask(!0),ce.setPolygonOffset(!1)}function el(M,U,V,B){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;if(E.state.transmissionRenderTarget[B.id]===void 0){const ye=He.has("EXT_color_buffer_half_float")||He.has("EXT_color_buffer_float");E.state.transmissionRenderTarget[B.id]=new on(1,1,{generateMipmaps:!0,type:ye?_n:Bt,minFilter:Kn,samples:Math.max(4,nt.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:ke.workingColorSpace})}const ue=E.state.transmissionRenderTarget[B.id],_e=B.viewport||j;ue.setSize(_e.z*L.transmissionResolutionScale,_e.w*L.transmissionResolutionScale);const he=L.getRenderTarget(),ve=L.getActiveCubeFace(),Se=L.getActiveMipmapLevel();L.setRenderTarget(ue),L.getClearColor(xe),Ee=L.getClearAlpha(),Ee<1&&L.setClearColor(16777215,.5),L.clear(),ot&&te.render(V);const De=L.toneMapping;L.toneMapping=rn;const Fe=B.viewport;if(B.viewport!==void 0&&(B.viewport=void 0),E.setupLightsView(B),at===!0&&ge.setGlobalState(L.clippingPlanes,B),Hr(M,V,B),_.updateMultisampleRenderTarget(ue),_.updateRenderTargetMipmap(ue),He.has("WEBGL_multisampled_render_to_texture")===!1){let ye=!1;for(let je=0,pt=U.length;je<pt;je++){const ft=U[je],{object:et,geometry:Lt,material:me,group:kt}=ft;if(me.side===Ot&&et.layers.test(B.layers)){const qe=me.side;me.side=ct,me.needsUpdate=!0,tl(et,V,B,Lt,me,kt),me.side=qe,me.needsUpdate=!0,ye=!0}}ye===!0&&(_.updateMultisampleRenderTarget(ue),_.updateRenderTargetMipmap(ue))}L.setRenderTarget(he,ve,Se),L.setClearColor(xe,Ee),Fe!==void 0&&(B.viewport=Fe),L.toneMapping=De}function Hr(M,U,V){const B=U.isScene===!0?U.overrideMaterial:null;for(let z=0,ue=M.length;z<ue;z++){const _e=M[z],{object:he,geometry:ve,group:Se}=_e;let De=_e.material;De.allowOverride===!0&&B!==null&&(De=B),he.layers.test(V.layers)&&tl(he,U,V,ve,De,Se)}}function tl(M,U,V,B,z,ue){M.onBeforeRender(L,U,V,B,z,ue),M.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,M.matrixWorld),M.normalMatrix.getNormalMatrix(M.modelViewMatrix),z.onBeforeRender(L,U,V,B,M,ue),z.transparent===!0&&z.side===Ot&&z.forceSinglePass===!1?(z.side=ct,z.needsUpdate=!0,L.renderBufferDirect(V,U,B,z,M,ue),z.side=Wt,z.needsUpdate=!0,L.renderBufferDirect(V,U,B,z,M,ue),z.side=Ot):L.renderBufferDirect(V,U,B,z,M,ue),M.onAfterRender(L,U,V,B,z,ue)}function kr(M,U,V){U.isScene!==!0&&(U=vt);const B=T.get(M),z=E.state.lights,ue=E.state.shadowsArray,_e=z.state.version,he=ae.getParameters(M,z.state,ue,U,V,E.state.lightProbeGridArray),ve=ae.getProgramCacheKey(he);let Se=B.programs;B.environment=M.isMeshStandardMaterial||M.isMeshLambertMaterial||M.isMeshPhongMaterial?U.environment:null,B.fog=U.fog;const De=M.isMeshStandardMaterial||M.isMeshLambertMaterial&&!M.envMap||M.isMeshPhongMaterial&&!M.envMap;B.envMap=O.get(M.envMap||B.environment,De),B.envMapRotation=B.environment!==null&&M.envMap===null?U.environmentRotation:M.envMapRotation,Se===void 0&&(M.addEventListener("dispose",dt),Se=new Map,B.programs=Se);let Fe=Se.get(ve);if(Fe!==void 0){if(B.currentProgram===Fe&&B.lightsStateVersion===_e)return il(M,he),Fe}else he.uniforms=ae.getUniforms(M),F!==null&&M.isNodeMaterial&&F.build(M,V,he),M.onBeforeCompile(he,L),Fe=ae.acquireProgram(he,ve),Se.set(ve,Fe),B.uniforms=he.uniforms;const ye=B.uniforms;return(!M.isShaderMaterial&&!M.isRawShaderMaterial||M.clipping===!0)&&(ye.clippingPlanes=ge.uniform),il(M,he),B.needsLights=wm(M),B.lightsStateVersion=_e,B.needsLights&&(ye.ambientLightColor.value=z.state.ambient,ye.lightProbe.value=z.state.probe,ye.directionalLights.value=z.state.directional,ye.directionalLightShadows.value=z.state.directionalShadow,ye.spotLights.value=z.state.spot,ye.spotLightShadows.value=z.state.spotShadow,ye.rectAreaLights.value=z.state.rectArea,ye.ltc_1.value=z.state.rectAreaLTC1,ye.ltc_2.value=z.state.rectAreaLTC2,ye.pointLights.value=z.state.point,ye.pointLightShadows.value=z.state.pointShadow,ye.hemisphereLights.value=z.state.hemi,ye.directionalShadowMatrix.value=z.state.directionalShadowMatrix,ye.spotLightMatrix.value=z.state.spotLightMatrix,ye.spotLightMap.value=z.state.spotLightMap,ye.pointShadowMatrix.value=z.state.pointShadowMatrix),B.lightProbeGrid=E.state.lightProbeGridArray.length>0,B.currentProgram=Fe,B.uniformsList=null,Fe}function nl(M){if(M.uniformsList===null){const U=M.currentProgram.getUniforms();M.uniformsList=Nr.seqWithValue(U.seq,M.uniforms)}return M.uniformsList}function il(M,U){const V=T.get(M);V.outputColorSpace=U.outputColorSpace,V.batching=U.batching,V.batchingColor=U.batchingColor,V.instancing=U.instancing,V.instancingColor=U.instancingColor,V.instancingMorph=U.instancingMorph,V.skinning=U.skinning,V.morphTargets=U.morphTargets,V.morphNormals=U.morphNormals,V.morphColors=U.morphColors,V.morphTargetsCount=U.morphTargetsCount,V.numClippingPlanes=U.numClippingPlanes,V.numIntersection=U.numClipIntersection,V.vertexAlphas=U.vertexAlphas,V.vertexTangents=U.vertexTangents,V.toneMapping=U.toneMapping}function bm(M,U){if(M.length===0)return null;if(M.length===1)return M[0].texture!==null?M[0]:null;y.setFromMatrixPosition(U.matrixWorld);for(let V=0,B=M.length;V<B;V++){const z=M[V];if(z.texture!==null&&z.boundingBox.containsPoint(y))return z}return null}function Tm(M,U,V,B,z){U.isScene!==!0&&(U=vt),_.resetTextureUnits();const ue=U.fog,_e=B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial?U.environment:null,he=N===null?L.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:ke.workingColorSpace,ve=B.isMeshStandardMaterial||B.isMeshLambertMaterial&&!B.envMap||B.isMeshPhongMaterial&&!B.envMap,Se=O.get(B.envMap||_e,ve),De=B.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,Fe=!!V.attributes.tangent&&(!!B.normalMap||B.anisotropy>0),ye=!!V.morphAttributes.position,je=!!V.morphAttributes.normal,pt=!!V.morphAttributes.color;let ft=rn;B.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(ft=L.toneMapping);const et=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Lt=et!==void 0?et.length:0,me=T.get(B),kt=E.state.lights;if(at===!0&&(Ve===!0||M!==H)){const it=M===H&&B.id===G;ge.setState(B,M,it)}let qe=!1;B.version===me.__version?(me.needsLights&&me.lightsStateVersion!==kt.state.version||me.outputColorSpace!==he||z.isBatchedMesh&&me.batching===!1||!z.isBatchedMesh&&me.batching===!0||z.isBatchedMesh&&me.batchingColor===!0&&z.colorTexture===null||z.isBatchedMesh&&me.batchingColor===!1&&z.colorTexture!==null||z.isInstancedMesh&&me.instancing===!1||!z.isInstancedMesh&&me.instancing===!0||z.isSkinnedMesh&&me.skinning===!1||!z.isSkinnedMesh&&me.skinning===!0||z.isInstancedMesh&&me.instancingColor===!0&&z.instanceColor===null||z.isInstancedMesh&&me.instancingColor===!1&&z.instanceColor!==null||z.isInstancedMesh&&me.instancingMorph===!0&&z.morphTexture===null||z.isInstancedMesh&&me.instancingMorph===!1&&z.morphTexture!==null||me.envMap!==Se||B.fog===!0&&me.fog!==ue||me.numClippingPlanes!==void 0&&(me.numClippingPlanes!==ge.numPlanes||me.numIntersection!==ge.numIntersection)||me.vertexAlphas!==De||me.vertexTangents!==Fe||me.morphTargets!==ye||me.morphNormals!==je||me.morphColors!==pt||me.toneMapping!==ft||me.morphTargetsCount!==Lt||!!me.lightProbeGrid!=E.state.lightProbeGridArray.length>0)&&(qe=!0):(qe=!0,me.__version=B.version);let Kt=me.currentProgram;qe===!0&&(Kt=kr(B,U,z),F&&B.isNodeMaterial&&F.onUpdateProgram(B,Kt,me));let pn=!1,Vn=!1,Di=!1;const tt=Kt.getUniforms(),mt=me.uniforms;if(ce.useProgram(Kt.program)&&(pn=!0,Vn=!0,Di=!0),B.id!==G&&(G=B.id,Vn=!0),me.needsLights){const it=bm(E.state.lightProbeGridArray,z);me.lightProbeGrid!==it&&(me.lightProbeGrid=it,Vn=!0)}if(pn||H!==M){ce.buffers.depth.getReversed()&&M.reversedDepth!==!0&&(M._reversedDepth=!0,M.updateProjectionMatrix()),tt.setValue(I,"projectionMatrix",M.projectionMatrix),tt.setValue(I,"viewMatrix",M.matrixWorldInverse);const kn=tt.map.cameraPosition;kn!==void 0&&kn.setValue(I,rt.setFromMatrixPosition(M.matrixWorld)),nt.logarithmicDepthBuffer&&tt.setValue(I,"logDepthBufFC",2/(Math.log(M.far+1)/Math.LN2)),(B.isMeshPhongMaterial||B.isMeshToonMaterial||B.isMeshLambertMaterial||B.isMeshBasicMaterial||B.isMeshStandardMaterial||B.isShaderMaterial)&&tt.setValue(I,"isOrthographic",M.isOrthographicCamera===!0),H!==M&&(H=M,Vn=!0,Di=!0)}if(me.needsLights&&(kt.state.directionalShadowMap.length>0&&tt.setValue(I,"directionalShadowMap",kt.state.directionalShadowMap,_),kt.state.spotShadowMap.length>0&&tt.setValue(I,"spotShadowMap",kt.state.spotShadowMap,_),kt.state.pointShadowMap.length>0&&tt.setValue(I,"pointShadowMap",kt.state.pointShadowMap,_)),z.isSkinnedMesh){tt.setOptional(I,z,"bindMatrix"),tt.setOptional(I,z,"bindMatrixInverse");const it=z.skeleton;it&&(it.boneTexture===null&&it.computeBoneTexture(),tt.setValue(I,"boneTexture",it.boneTexture,_))}z.isBatchedMesh&&(tt.setOptional(I,z,"batchingTexture"),tt.setValue(I,"batchingTexture",z._matricesTexture,_),tt.setOptional(I,z,"batchingIdTexture"),tt.setValue(I,"batchingIdTexture",z._indirectTexture,_),tt.setOptional(I,z,"batchingColorTexture"),z._colorsTexture!==null&&tt.setValue(I,"batchingColorTexture",z._colorsTexture,_));const Hn=V.morphAttributes;if((Hn.position!==void 0||Hn.normal!==void 0||Hn.color!==void 0)&&Re.update(z,V,Kt),(Vn||me.receiveShadow!==z.receiveShadow)&&(me.receiveShadow=z.receiveShadow,tt.setValue(I,"receiveShadow",z.receiveShadow)),(B.isMeshStandardMaterial||B.isMeshLambertMaterial||B.isMeshPhongMaterial)&&B.envMap===null&&U.environment!==null&&(mt.envMapIntensity.value=U.environmentIntensity),mt.dfgLUT!==void 0&&(mt.dfgLUT.value=rm()),Vn){if(tt.setValue(I,"toneMappingExposure",L.toneMappingExposure),me.needsLights&&Am(mt,Di),ue&&B.fog===!0&&X.refreshFogUniforms(mt,ue),X.refreshMaterialUniforms(mt,B,Ie,$e,E.state.transmissionRenderTarget[M.id]),me.needsLights&&me.lightProbeGrid){const it=me.lightProbeGrid;mt.probesSH.value=it.texture,mt.probesMin.value.copy(it.boundingBox.min),mt.probesMax.value.copy(it.boundingBox.max),mt.probesResolution.value.copy(it.resolution)}Nr.upload(I,nl(me),mt,_)}if(B.isShaderMaterial&&B.uniformsNeedUpdate===!0&&(Nr.upload(I,nl(me),mt,_),B.uniformsNeedUpdate=!1),B.isSpriteMaterial&&tt.setValue(I,"center",z.center),tt.setValue(I,"modelViewMatrix",z.modelViewMatrix),tt.setValue(I,"normalMatrix",z.normalMatrix),tt.setValue(I,"modelMatrix",z.matrixWorld),B.uniformsGroups!==void 0){const it=B.uniformsGroups;for(let kn=0,Ii=it.length;kn<Ii;kn++){const rl=it[kn];q.update(rl,Kt),q.bind(rl,Kt)}}return Kt}function Am(M,U){M.ambientLightColor.needsUpdate=U,M.lightProbe.needsUpdate=U,M.directionalLights.needsUpdate=U,M.directionalLightShadows.needsUpdate=U,M.pointLights.needsUpdate=U,M.pointLightShadows.needsUpdate=U,M.spotLights.needsUpdate=U,M.spotLightShadows.needsUpdate=U,M.rectAreaLights.needsUpdate=U,M.hemisphereLights.needsUpdate=U}function wm(M){return M.isMeshLambertMaterial||M.isMeshToonMaterial||M.isMeshPhongMaterial||M.isMeshStandardMaterial||M.isShadowMaterial||M.isShaderMaterial&&M.lights===!0}this.getActiveCubeFace=function(){return k},this.getActiveMipmapLevel=function(){return W},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(M,U,V){const B=T.get(M);B.__autoAllocateDepthBuffer=M.resolveDepthBuffer===!1,B.__autoAllocateDepthBuffer===!1&&(B.__useRenderToTexture=!1),T.get(M.texture).__webglTexture=U,T.get(M.depthTexture).__webglTexture=B.__autoAllocateDepthBuffer?void 0:V,B.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(M,U){const V=T.get(M);V.__webglFramebuffer=U,V.__useDefaultFramebuffer=U===void 0};const Rm=I.createFramebuffer();this.setRenderTarget=function(M,U=0,V=0){N=M,k=U,W=V;let B=null,z=!1,ue=!1;if(M){const he=T.get(M);if(he.__useDefaultFramebuffer!==void 0){ce.bindFramebuffer(I.FRAMEBUFFER,he.__webglFramebuffer),j.copy(M.viewport),Q.copy(M.scissor),le=M.scissorTest,ce.viewport(j),ce.scissor(Q),ce.setScissorTest(le),G=-1;return}else if(he.__webglFramebuffer===void 0)_.setupRenderTarget(M);else if(he.__hasExternalTextures)_.rebindTextures(M,T.get(M.texture).__webglTexture,T.get(M.depthTexture).__webglTexture);else if(M.depthBuffer){const De=M.depthTexture;if(he.__boundDepthTexture!==De){if(De!==null&&T.has(De)&&(M.width!==De.image.width||M.height!==De.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");_.setupDepthRenderbuffer(M)}}const ve=M.texture;(ve.isData3DTexture||ve.isDataArrayTexture||ve.isCompressedArrayTexture)&&(ue=!0);const Se=T.get(M).__webglFramebuffer;M.isWebGLCubeRenderTarget?(Array.isArray(Se[U])?B=Se[U][V]:B=Se[U],z=!0):M.samples>0&&_.useMultisampledRTT(M)===!1?B=T.get(M).__webglMultisampledFramebuffer:Array.isArray(Se)?B=Se[V]:B=Se,j.copy(M.viewport),Q.copy(M.scissor),le=M.scissorTest}else j.copy(ie).multiplyScalar(Ie).floor(),Q.copy(Ae).multiplyScalar(Ie).floor(),le=Pe;if(V!==0&&(B=Rm),ce.bindFramebuffer(I.FRAMEBUFFER,B)&&ce.drawBuffers(M,B),ce.viewport(j),ce.scissor(Q),ce.setScissorTest(le),z){const he=T.get(M.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_CUBE_MAP_POSITIVE_X+U,he.__webglTexture,V)}else if(ue){const he=U;for(let ve=0;ve<M.textures.length;ve++){const Se=T.get(M.textures[ve]);I.framebufferTextureLayer(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0+ve,Se.__webglTexture,V,he)}}else if(M!==null&&V!==0){const he=T.get(M.texture);I.framebufferTexture2D(I.FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,he.__webglTexture,V)}G=-1},this.readRenderTargetPixels=function(M,U,V,B,z,ue,_e,he=0){if(!(M&&M.isWebGLRenderTarget)){We("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let ve=T.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&_e!==void 0&&(ve=ve[_e]),ve){ce.bindFramebuffer(I.FRAMEBUFFER,ve);try{const Se=M.textures[he],De=Se.format,Fe=Se.type;if(M.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+he),!nt.textureFormatReadable(De)){We("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!nt.textureTypeReadable(Fe)){We("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=M.width-B&&V>=0&&V<=M.height-z&&I.readPixels(U,V,B,z,D.convert(De),D.convert(Fe),ue)}finally{const Se=N!==null?T.get(N).__webglFramebuffer:null;ce.bindFramebuffer(I.FRAMEBUFFER,Se)}}},this.readRenderTargetPixelsAsync=function(M,U,V,B,z,ue,_e,he=0){return Za(this,null,function*(){if(!(M&&M.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let ve=T.get(M).__webglFramebuffer;if(M.isWebGLCubeRenderTarget&&_e!==void 0&&(ve=ve[_e]),ve)if(U>=0&&U<=M.width-B&&V>=0&&V<=M.height-z){ce.bindFramebuffer(I.FRAMEBUFFER,ve);const Se=M.textures[he],De=Se.format,Fe=Se.type;if(M.textures.length>1&&I.readBuffer(I.COLOR_ATTACHMENT0+he),!nt.textureFormatReadable(De))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!nt.textureTypeReadable(Fe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ye=I.createBuffer();I.bindBuffer(I.PIXEL_PACK_BUFFER,ye),I.bufferData(I.PIXEL_PACK_BUFFER,ue.byteLength,I.STREAM_READ),I.readPixels(U,V,B,z,D.convert(De),D.convert(Fe),0);const je=N!==null?T.get(N).__webglFramebuffer:null;ce.bindFramebuffer(I.FRAMEBUFFER,je);const pt=I.fenceSync(I.SYNC_GPU_COMMANDS_COMPLETE,0);return I.flush(),yield Gl(I,pt,4),I.bindBuffer(I.PIXEL_PACK_BUFFER,ye),I.getBufferSubData(I.PIXEL_PACK_BUFFER,0,ue),I.deleteBuffer(ye),I.deleteSync(pt),ue}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")})},this.copyFramebufferToTexture=function(M,U=null,V=0){const B=Math.pow(2,-V),z=Math.floor(M.image.width*B),ue=Math.floor(M.image.height*B),_e=U!==null?U.x:0,he=U!==null?U.y:0;_.setTexture2D(M,0),I.copyTexSubImage2D(I.TEXTURE_2D,V,0,0,_e,he,z,ue),ce.unbindTexture()};const Cm=I.createFramebuffer(),Pm=I.createFramebuffer();this.copyTextureToTexture=function(M,U,V=null,B=null,z=0,ue=0){let _e,he,ve,Se,De,Fe,ye,je,pt;const ft=M.isCompressedTexture?M.mipmaps[ue]:M.image;if(V!==null)_e=V.max.x-V.min.x,he=V.max.y-V.min.y,ve=V.isBox3?V.max.z-V.min.z:1,Se=V.min.x,De=V.min.y,Fe=V.isBox3?V.min.z:0;else{const mt=Math.pow(2,-z);_e=Math.floor(ft.width*mt),he=Math.floor(ft.height*mt),M.isDataArrayTexture?ve=ft.depth:M.isData3DTexture?ve=Math.floor(ft.depth*mt):ve=1,Se=0,De=0,Fe=0}B!==null?(ye=B.x,je=B.y,pt=B.z):(ye=0,je=0,pt=0);const et=D.convert(U.format),Lt=D.convert(U.type);let me;U.isData3DTexture?(_.setTexture3D(U,0),me=I.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(_.setTexture2DArray(U,0),me=I.TEXTURE_2D_ARRAY):(_.setTexture2D(U,0),me=I.TEXTURE_2D),ce.activeTexture(I.TEXTURE0),ce.pixelStorei(I.UNPACK_FLIP_Y_WEBGL,U.flipY),ce.pixelStorei(I.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),ce.pixelStorei(I.UNPACK_ALIGNMENT,U.unpackAlignment);const kt=ce.getParameter(I.UNPACK_ROW_LENGTH),qe=ce.getParameter(I.UNPACK_IMAGE_HEIGHT),Kt=ce.getParameter(I.UNPACK_SKIP_PIXELS),pn=ce.getParameter(I.UNPACK_SKIP_ROWS),Vn=ce.getParameter(I.UNPACK_SKIP_IMAGES);ce.pixelStorei(I.UNPACK_ROW_LENGTH,ft.width),ce.pixelStorei(I.UNPACK_IMAGE_HEIGHT,ft.height),ce.pixelStorei(I.UNPACK_SKIP_PIXELS,Se),ce.pixelStorei(I.UNPACK_SKIP_ROWS,De),ce.pixelStorei(I.UNPACK_SKIP_IMAGES,Fe);const Di=M.isDataArrayTexture||M.isData3DTexture,tt=U.isDataArrayTexture||U.isData3DTexture;if(M.isDepthTexture){const mt=T.get(M),Hn=T.get(U),it=T.get(mt.__renderTarget),kn=T.get(Hn.__renderTarget);ce.bindFramebuffer(I.READ_FRAMEBUFFER,it.__webglFramebuffer),ce.bindFramebuffer(I.DRAW_FRAMEBUFFER,kn.__webglFramebuffer);for(let Ii=0;Ii<ve;Ii++)Di&&(I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,T.get(M).__webglTexture,z,Fe+Ii),I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,T.get(U).__webglTexture,ue,pt+Ii)),I.blitFramebuffer(Se,De,_e,he,ye,je,_e,he,I.DEPTH_BUFFER_BIT,I.NEAREST);ce.bindFramebuffer(I.READ_FRAMEBUFFER,null),ce.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else if(z!==0||M.isRenderTargetTexture||T.has(M)){const mt=T.get(M),Hn=T.get(U);ce.bindFramebuffer(I.READ_FRAMEBUFFER,Cm),ce.bindFramebuffer(I.DRAW_FRAMEBUFFER,Pm);for(let it=0;it<ve;it++)Di?I.framebufferTextureLayer(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,mt.__webglTexture,z,Fe+it):I.framebufferTexture2D(I.READ_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,mt.__webglTexture,z),tt?I.framebufferTextureLayer(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,Hn.__webglTexture,ue,pt+it):I.framebufferTexture2D(I.DRAW_FRAMEBUFFER,I.COLOR_ATTACHMENT0,I.TEXTURE_2D,Hn.__webglTexture,ue),z!==0?I.blitFramebuffer(Se,De,_e,he,ye,je,_e,he,I.COLOR_BUFFER_BIT,I.NEAREST):tt?I.copyTexSubImage3D(me,ue,ye,je,pt+it,Se,De,_e,he):I.copyTexSubImage2D(me,ue,ye,je,Se,De,_e,he);ce.bindFramebuffer(I.READ_FRAMEBUFFER,null),ce.bindFramebuffer(I.DRAW_FRAMEBUFFER,null)}else tt?M.isDataTexture||M.isData3DTexture?I.texSubImage3D(me,ue,ye,je,pt,_e,he,ve,et,Lt,ft.data):U.isCompressedArrayTexture?I.compressedTexSubImage3D(me,ue,ye,je,pt,_e,he,ve,et,ft.data):I.texSubImage3D(me,ue,ye,je,pt,_e,he,ve,et,Lt,ft):M.isDataTexture?I.texSubImage2D(I.TEXTURE_2D,ue,ye,je,_e,he,et,Lt,ft.data):M.isCompressedTexture?I.compressedTexSubImage2D(I.TEXTURE_2D,ue,ye,je,ft.width,ft.height,et,ft.data):I.texSubImage2D(I.TEXTURE_2D,ue,ye,je,_e,he,et,Lt,ft);ce.pixelStorei(I.UNPACK_ROW_LENGTH,kt),ce.pixelStorei(I.UNPACK_IMAGE_HEIGHT,qe),ce.pixelStorei(I.UNPACK_SKIP_PIXELS,Kt),ce.pixelStorei(I.UNPACK_SKIP_ROWS,pn),ce.pixelStorei(I.UNPACK_SKIP_IMAGES,Vn),ue===0&&U.generateMipmaps&&I.generateMipmap(me),ce.unbindTexture()},this.initRenderTarget=function(M){T.get(M).__webglFramebuffer===void 0&&_.setupRenderTarget(M)},this.initTexture=function(M){M.isCubeTexture?_.setTextureCube(M,0):M.isData3DTexture?_.setTexture3D(M,0):M.isDataArrayTexture||M.isCompressedArrayTexture?_.setTexture2DArray(M,0):_.setTexture2D(M,0),ce.unbindTexture()},this.resetState=function(){k=0,W=0,N=null,ce.reset(),ne.reset()},typeof __THREE_DEVTOOLS__!="undefined"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return an}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=ke._getDrawingBufferColorSpace(e),t.unpackColorSpace=ke._getUnpackColorSpace()}}function am(){const i=new nh;i.background=new Ge(6992094),i.fog=new sa(9091286,.002);const e=new Yt(65,innerWidth/innerHeight,.3,2e3),t=new sm({antialias:!0,powerPreference:"high-performance"});t.setPixelRatio(Math.min(devicePixelRatio,2)),t.setSize(innerWidth,innerHeight),t.shadowMap.enabled=!0,t.shadowMap.type=ji,t.toneMapping=ns,t.toneMappingExposure=1,document.body.appendChild(t.domElement),window.addEventListener("resize",()=>{e.aspect=innerWidth/innerHeight,e.updateProjectionMatrix(),t.setSize(innerWidth,innerHeight)});const n=new Oh(8900331,3829288,.7);i.add(n);const r=new sc(16773328,1.2);r.position.set(80,150,60),r.castShadow=!0,r.shadow.mapSize.set(2048,2048),r.shadow.camera.near=1,r.shadow.camera.far=400,r.shadow.camera.left=-150,r.shadow.camera.right=150,r.shadow.camera.top=150,r.shadow.camera.bottom=-150,r.shadow.bias=-.001,i.add(r);const s=new sc(11194623,.3);return s.position.set(-50,80,-40),i.add(s),{scene:i,camera:e,renderer:t}}function om(i){const t=[];for(let c=0;c<30;c++){const l=c/30*Math.PI*2,u=120+Math.sin(l*3)*20+Math.cos(l*5)*10+Math.sin(l*7)*8,f=Math.cos(l)*u,h=Math.sin(l)*u*.65,p=Math.sin(l*2)*8+Math.cos(l*3)*4;t.push(new P(f,p,h))}t.push(t[0].clone());const r=new Ai(t,!0,"catmullrom",.5),s=r.getLength(),a=[];{const c=r.getPointAt(.22),l=r.getPointAt(.38),u=r.getPointAt(.25),f=r.getPointAt(.42),h=new P(u.x+50,u.y+30,u.z-20),p=new P(f.x+40,f.y+25,f.z-30),x=c.clone().lerp(h,.3),b=l.clone().lerp(p,.3),m=new Ai([c,x,h,p,b,l],!1,"catmullrom",.5);a.push({entryT:.22,entryDistance:.22*s,exitT:.38,exitDistance:.38*s,branchCurve:m})}{const c=r.getPointAt(.52),l=r.getPointAt(.7),u=r.getPointAt(.62),f=new P(u.x-30,-6,u.z+20),h=c.clone().lerp(f,.4),p=l.clone().lerp(f,.4),x=new Ai([c,h,f,p,l],!1,"catmullrom",.5);a.push({entryT:.52,entryDistance:.52*s,exitT:.7,exitDistance:.7*s,branchCurve:x})}{const c=r.getPointAt(.78),l=r.getPointAt(.92),u=c.clone().lerp(l,.5);u.y+=5;const f=new Ai([c,c.clone().add(new P(20,10,10)),u,l.clone().add(new P(-15,8,-10)),l],!1,"catmullrom",.5);a.push({entryT:.78,entryDistance:.78*s,exitT:.92,exitDistance:.92*s,branchCurve:f})}const o={mainCurve:r,mainLen:s,junctions:a,getPointOnMain(c){const l=(c%s+s)%s/s;return{pos:r.getPointAt(l),tangent:r.getTangentAt(l)}}};zc(i,r);for(const c of a)c.branchCurve&&zc(i,c.branchCurve);return o}function zc(i,e){const t=new ht({color:8949912,metalness:.5,roughness:.4}),n=new ht({color:5914672,roughness:.9}),r=e.getLength(),s=Math.floor(r/2.5),a=[],o=[];for(let x=0;x<=s;x++){const b=x/s;a.push(e.getPointAt(b)),o.push(e.getTangentAt(b))}new Ut;const c=[],l=[],u=.7,f=.04,h=.12;for(let x=0;x<a.length;x++){const b=a[x],m=o[x],d=new P(-m.z,0,m.x).normalize();for(const v of[-1,1]){const S=d.clone().multiplyScalar(v*u);c.push(b.x+S.x-d.x*f,b.y,b.z+S.z-d.z*f,b.x+S.x+d.x*f,b.y,b.z+S.z+d.z*f,b.x+S.x+d.x*f,b.y+h,b.z+S.z+d.z*f,b.x+S.x-d.x*f,b.y+h,b.z+S.z-d.z*f)}}const p=a.length-1;for(let x=0;x<p;x++){const b=x*8,m=(x+1)*8;for(const d of[0,4]){const v=b+d,S=m+d,y=[0,1,2,0,2,3,1,5,6,1,6,2,2,6,7,2,7,3,3,7,4,3,4,0,0,5,1,0,4,5,4,7,6,4,6,5];for(const w of y)l.push([v,S][w<6?0:1]+(w<6?w:w-6))}}i.add(cm(e,t)),lm(i,e,n)}function cm(i,e){const t=new yn,n=i.getLength(),r=Math.floor(n/1.5),s=.7;for(const a of[-1,1]){const o=[];for(let f=0;f<=r;f++){const h=f/r,p=i.getPointAt(h),x=i.getTangentAt(h),m=new P(-x.z,0,x.x).normalize().clone().multiplyScalar(a*s);o.push(new P(p.x+m.x,p.y+.06,p.z+m.z))}const c=new Ai(o),l=new Pa(c,Math.floor(r/2),.05,4,!1),u=new Be(l,e);u.receiveShadow=!0,u.castShadow=!0,t.add(u)}return t}function lm(i,e,t){const n=e.getLength(),r=Math.floor(n/3.5),s=new Tt(2,.1,.18),a=new Ma(s,t,r);a.castShadow=!0,a.receiveShadow=!0,a.count=r;const o=new Qe,c=new P,l=new vn;for(let u=0;u<r;u++){const f=u*3.5/n,h=e.getPointAt(Math.min(1,f)),p=e.getTangentAt(Math.min(1,f));c.copy(h),c.y+=.05,l.setFromUnitVectors(new P(0,1,0),new P(-p.z,0,p.x).normalize()),o.compose(c,l,new P(1,1,1)),a.setMatrixAt(u,o)}a.instanceMatrix.needsUpdate=!0,i.add(a)}const Or=[{body:2975433,stripe:16777215,wagon:13382434},{body:13386769,stripe:16763904,wagon:2258892},{body:2271812,stripe:16777215,wagon:13404211},{body:8926156,stripe:16763904,wagon:4500036},{body:16720486,stripe:16777215,wagon:3377356}];function Gc(i){const e=new yn,t=2.8,n=.6,r=new ht({color:i.body,roughness:.3,metalness:.4}),s=new ht({color:1974832,roughness:.8,metalness:.2}),a=new ht({color:i.stripe,roughness:.3,metalness:.1}),o=new ht({color:8965375,roughness:.05,transparent:!0,opacity:.45}),c=new ht({color:1710618,roughness:.9}),l=new ht({color:16777130,emissive:16777130,emissiveIntensity:2}),u=new Be(new Tt(t,.12,n+.08),s);u.position.y=.28,e.add(u);const f=new Be(new Tt(t-.2,.55,n),r);f.position.y=.65,e.add(f);const h=new Be(new Cr(.38,.7,10),r);h.rotation.x=Math.PI/2,h.position.set(0,.62,-t/2-.15),e.add(h);const p=new Be(new Tt(t-.32,.08,n-.04),new ht({color:14147046,roughness:.6}));p.position.y=.95,e.add(p);for(const d of[-1,1]){const v=new Be(new Tt(t-.15,.06,.02),a);v.position.set(0,.68,d*(n/2+.01)),e.add(v)}const x=new Be(new Bn(.06,6,4),l);x.position.set(0,.52,-t/2-.35),e.add(x);const b=new Be(new Tt(.18,.15,.02),o);b.position.set(0,.78,-t/2-.45),e.add(b);const m=[];for(const d of[-t*.27,t*.27])for(const v of[-.18,.18]){const S=new yn,y=new Be(new On(.08,.08,.05,8),c);y.rotation.z=Math.PI/2,S.add(y),S.position.set(0,.08,d);const w=new Be(new On(.08,.08,.05,8),c);w.rotation.z=Math.PI/2,w.position.set(v*.4,.08,d),e.add(w),m.push(w)}return e._len=t,e._wheelPairs=m,e}function Vc(i){const e=new yn,t=2,n=.54,r=new ht({color:i,roughness:.4,metalness:.3}),s=new ht({color:1974832,roughness:.8}),a=new Be(new Tt(t,.08,n+.04),s);a.position.y=.2,e.add(a);const o=new Be(new Tt(t-.1,.42,n),r);o.position.y=.48,e.add(o);const c=new Be(new Tt(t-.18,.06,n-.02),new ht({color:13685976,roughness:.6}));return c.position.y=.74,e.add(c),e._len=t,e}function hm(i){const e=Or[Math.floor(Math.random()*Or.length)],t={cars:[],couplers:[],hp:100,speed:0,baseSpeed:0,trackPos:0,onBranch:-1,branchProgress:0,isPlayer:!0},n=Gc(e);i.add(n),t.cars.push({mesh:n,len:n._len});for(let s=0;s<4;s++){const a=Vc(s%2===0?e.wagon:13382434);i.add(a),t.cars.push({mesh:a,len:a._len})}const r=new ht({color:5263968,roughness:.7});for(let s=0;s<t.cars.length-1;s++){const a=new Be(new On(.03,.03,.3,4),r);i.add(a),t.couplers.push(a)}return t}function um(i){const e=Or[Math.floor(Math.random()*Or.length)],t={cars:[],couplers:[],hp:100,speed:0,baseSpeed:12+Math.random()*8,trackPos:0,onBranch:-1,branchProgress:0,isPlayer:!1},n=Gc(e);i.add(n),t.cars.push({mesh:n,len:n._len});for(let s=0;s<3;s++){const a=Vc(s%2===0?e.wagon:13382434);i.add(a),t.cars.push({mesh:a,len:a._len})}const r=new ht({color:5263968,roughness:.7});for(let s=0;s<t.cars.length-1;s++){const a=new Be(new On(.03,.03,.3,4),r);i.add(a),t.couplers.push(a)}return t}function Hc(i,e){var c;if(!i||i.cars.length===0)return;const t=.1;let n=0;const r=[],s=new P(0,1,0),a=new P,o=new vn;for(let l=0;l<i.cars.length;l++){const u=i.cars[l],f=n+u.len*.5;let h,p;if(i.onBranch>=0&&i.onBranch<e.junctions.length){const d=e.junctions[i.onBranch],v=Math.max(0,Math.min(1,i.branchProgress-f/300));if(v>=0&&v<=1)h=d.branchCurve.getPointAt(v),p=d.branchCurve.getTangentAt(v);else{const S=e.getPointOnMain(i.trackPos-f);h=S.pos,p=S.tangent}}else{const d=e.getPointOnMain(i.trackPos-f);h=d.pos,p=d.tangent}u.mesh.position.copy(h),u.mesh.position.y+=.35;const x=Math.atan2(p.x,p.z);if(u.mesh.rotation.set(0,x,0),l===0){const d=i.onBranch>=0?(c=e.junctions[i.onBranch])==null?void 0:c.branchCurve.getTangentAt(Math.min(1,i.branchProgress+.02)):e.getPointOnMain(i.trackPos+1).tangent;if(d){const v=p.clone().cross(d).y;u.mesh.rotation.z=Math.max(-.1,Math.min(.1,-v*2))}}if(u.mesh._wheelPairs){const d=i.trackPos*.5;for(const v of u.mesh._wheelPairs)v.rotation.x=d}const b=new P(u.len*.5-.02,0,0).applyQuaternion(u.mesh.quaternion).add(u.mesh.position),m=new P(-u.len*.5+.02,0,0).applyQuaternion(u.mesh.quaternion).add(u.mesh.position);r.push({front:b,back:m}),n+=u.len+t}for(let l=0;l<Math.min(i.couplers.length,r.length-1);l++){const u=i.couplers[l],f=r[l].back,h=r[l+1].front,p=a.copy(h).sub(f),x=p.length();u.position.copy(f.clone().add(h).multiplyScalar(.5)),u.position.y+=.25,x>.01&&(o.setFromUnitVectors(s,p.clone().normalize()),u.quaternion.copy(o),u.scale.set(1,x,1))}}function fm(i,e,t,n){if(i.hp<=0||!i.cars[0])return;const r=i.cars[0].mesh.position;for(const s of e){if(s.hp<=0||!s.cars[0])continue;const a=s.cars[0].mesh.position;if(r.distanceTo(a)>6)continue;const c=Math.abs(i.speed-s.speed),l=c<10?1:c<25?2:3,u=l===1?15:l===2?35:60;i.hp=Math.max(0,i.hp-u),i.speed*=.3,s.speed*=.3;const f=(r.x+a.x)/2,h=(r.z+a.z)/2;n.spawnCrash(f,h,l),t.crashes++,i.hp<=0&&(t.gameOver=!0,document.getElementById("goDist").textContent=t.distance,document.getElementById("goStar").textContent=t.stars,document.getElementById("goCrash").textContent=t.crashes,setTimeout(()=>document.getElementById("gameover").classList.add("show"),300));break}}function dm(i,e){const t=new yn;i.add(t);const n=new ht({color:4885058,roughness:.9}),r=new Be(new Ki(2e3,2e3),n);r.rotation.x=-Math.PI/2,r.position.y=-.3,r.receiveShadow=!0,t.add(r);const s=new ht({color:3832370,roughness:.9});for(let w=0;w<10;w++){const E=Math.random()*Math.PI*2,R=50+Math.random()*80,g=12+Math.random()*20,A=8+Math.random()*15,L=new Be(new Bn(g,8,6,0,Math.PI*2,0,Math.PI/2),s);L.position.set(Math.cos(E)*R,-g/2+A*.1,Math.sin(E)*R*.65),L.scale.y=A/g*.6,t.add(L)}const a=new ht({color:2980397,roughness:.9}),o=new ht({color:5913120,roughness:.95}),c=[];for(let w=0;w<80;w++){const E=(w/80+Math.random()*.01)%1,R=e.mainCurve.getPointAt(E),g=e.mainCurve.getTangentAt(E),A=Math.random()>.5?1:-1;c.push({x:R.x-g.z*A*(5+Math.random()*12),z:R.z+g.x*A*(5+Math.random()*12),y:R.y,sc:.6+Math.random()*1.2})}for(let w=0;w<120;w++)c.push({x:(Math.random()-.5)*350,z:(Math.random()-.5)*350,y:0,sc:.5+Math.random()*1});const l=new On(.06,.1,1.2,4),u=new Cr(.7,1.6,6),f=new Ma(l,o,c.length),h=new Ma(u,a,c.length),p=new Qe,x=new P,b=new vn;c.forEach((w,E)=>{x.set(w.x,w.y-.2,w.z),p.compose(x,b,new P(w.sc,w.sc,w.sc)),f.setMatrixAt(E,p),x.y=w.y+.8*w.sc,p.compose(x,b,new P(w.sc,w.sc,w.sc)),h.setMatrixAt(E,p)}),f.count=c.length,h.count=c.length,f.instanceMatrix.needsUpdate=!0,h.instanceMatrix.needsUpdate=!0,f.castShadow=!0,h.castShadow=!0,t.add(f),t.add(h);const m=[{t:.05,color:13404211},{t:.35,color:3377356},{t:.65,color:8965171}];for(const w of m){const E=e.mainCurve.getPointAt(w.t),R=e.mainCurve.getTangentAt(w.t),g=-R.z*3.5,A=R.x*3.5,L=new Be(new Tt(8,.15,3),new ht({color:8947848,roughness:.8}));L.position.set(E.x+g,E.y+.15,E.z+A),L.receiveShadow=!0,t.add(L);const C=new Be(new Tt(2.5,3,2.5),new ht({color:w.color,roughness:.5}));C.position.set(E.x+g-R.x*2,E.y+1.5,E.z+A-R.z*2),C.castShadow=!0,t.add(C)}const d=new ht({color:2263244,roughness:.1,metalness:.3,transparent:!0,opacity:.5});for(let w=0;w<4;w++){const E=Math.random()*Math.PI*2,R=40+Math.random()*50,g=new Be(new ya(10+Math.random()*12,16),d);g.rotation.x=-Math.PI/2,g.position.set(Math.cos(E)*R,-.25,Math.sin(E)*R*.65),t.add(g)}const v=[],S=new ht({color:16768256,emissive:16768256,emissiveIntensity:2}),y=new Ca(.35);for(let w=0;w<25;w++){const E=(.01+w/25)%1,R=e.mainCurve.getPointAt(E),g=e.mainCurve.getTangentAt(E),A=Math.random()>.5?1:-1,L=new Be(y,S.clone());L.position.set(R.x-g.z*A*2.2,R.y+1.5+Math.random()*.5,R.z+g.x*A*2.2),L.userData={collected:!1,baseY:L.position.y},v.push(L),t.add(L);const C=new Be(new Bn(.55,6,4),new yi({color:16768256,transparent:!0,opacity:.25}));C.position.copy(L.position),C.userData.parentStar=L,v.push(C),t.add(C)}return{update(w){const E=Date.now()/1e3;for(let R=0;R<v.length;R+=2){const g=v[R];g.userData.collected||(g.rotation.x=E*1.5+R,g.rotation.y=E*2+R*.5,g.position.y=g.userData.baseY+Math.sin(E*2+R)*.15,v[R+1]&&(v[R+1].position.copy(g.position),v[R+1].material.opacity=.2+Math.sin(E*3+R)*.1))}},checkStars(w,E){for(let R=0;R<v.length;R+=2){const g=v[R];if(!g.userData.collected&&w.distanceTo(g.position)<2)return g.userData.collected=!0,g.visible=!1,v[R+1]&&(v[R+1].visible=!1),E.stars++,!0}return!1}}}function pm(i){document.getElementById("speed-num").textContent=i.speed,document.getElementById("sDist").textContent=i.distance,document.getElementById("sStar").textContent=i.stars;const e=Math.max(0,i.hp),t=document.getElementById("hp-fill");t.style.width=e+"%",t.style.background=e>60?"#00ff88":e>30?"#ffcc00":"#ff4444"}const Br=60,mm=[16729088,16746496,16763904,16720384];function gm(i){const e=[],t=new yi({color:16772608});function n(s,a,o){const c=o>=3,l=c?25:15;for(let u=0;u<l&&!(e.length>=Br);u++){const f=new Be(new Bn(c?.2:.12,4,3),t.clone());f.material.color.setHex([16772608,16746496,16729088,16777215][Math.floor(Math.random()*4)]),f.position.set(s+(Math.random()-.5)*3,1+Math.random()*2,a+(Math.random()-.5)*3),i.add(f);const h=Math.random()*Math.PI*2,p=.5+Math.random()*(c?3:2);e.push({mesh:f,type:"spark",vx:Math.cos(h)*p,vy:.5+Math.random()*(c?2:1.2),vz:Math.sin(h)*p,life:1,decay:.04+Math.random()*.06})}for(let u=0;u<(c?4:2)&&!(e.length>=Br);u++){const f=new Be(new Bn(.8+Math.random()*.5,5,4),new yi({color:8947848,transparent:!0,opacity:.5,depthWrite:!1}));f.position.set(s+(Math.random()-.5)*2,.5,a+(Math.random()-.5)*2),i.add(f),e.push({mesh:f,type:"smoke",vx:(Math.random()-.5)*.5,vy:.08+Math.random()*.1,vz:(Math.random()-.5)*.5,life:1,decay:.015+Math.random()*.015})}if(o>=3)for(let u=0;u<15&&!(e.length>=Br);u++){const f=new Be(new Bn(.3+Math.random()*.6,5,4),new yi({color:mm[Math.floor(Math.random()*4)]}));f.position.set(s+(Math.random()-.5)*2,.5+Math.random()*1.5,a+(Math.random()-.5)*2),i.add(f),e.push({mesh:f,type:"fire",vx:(Math.random()-.5)*.08,vy:.1+Math.random()*.2,vz:(Math.random()-.5)*.08,life:1,decay:.03+Math.random()*.03})}if(c)for(let u=0;u<8&&!(e.length>=Br);u++){const f=new Be(new Tt(.1+Math.random()*.6,.05+Math.random()*.2,.1+Math.random()*.4),new Uh({color:[5592405,7829367,3355443,11176004][Math.floor(Math.random()*4)]}));f.position.set(s+(Math.random()-.5)*3,1.5,a+(Math.random()-.5)*3),i.add(f);const h=Math.random()*Math.PI*2;e.push({mesh:f,type:"debris",vx:Math.cos(h)*(.3+Math.random()*1.2),vy:.5+Math.random()*1.2,vz:Math.sin(h)*(.3+Math.random()*1.2),rx:(Math.random()-.5)*.2,rz:(Math.random()-.5)*.2,life:1,decay:.006+Math.random()*.006})}}function r(s){for(let a=e.length-1;a>=0;a--){const o=e[a];o.mesh.position.x+=o.vx,o.mesh.position.y+=o.vy,o.mesh.position.z+=o.vz,o.type==="spark"&&(o.vy-=.08,o.mesh.position.y<.1&&(o.mesh.position.y=.1,o.vy*=-.2)),o.type==="debris"&&(o.vy-=.05,o.mesh.position.y<.1&&(o.vy=0,o.vx*=.85,o.vz*=.85),o.rx&&(o.mesh.rotation.x+=o.rx),o.rz&&(o.mesh.rotation.z+=o.rz)),o.type==="fire"&&(o.vy*=.97,o.mesh.scale.setScalar(Math.max(.1,o.life)),o.mesh.material&&o.mesh.material.color.setHSL(.06*(1-o.life),1,.4+o.life*.3)),o.type==="smoke"&&o.mesh.scale.setScalar(1+(1-o.life)*2),o.life-=o.decay,o.mesh.material&&o.mesh.material.transparent&&(o.mesh.material.opacity=Math.max(0,o.life*.6)),o.life<=0&&(i.remove(o.mesh),e.splice(a,1))}}return{spawnCrash:n,update:r}}function kc(i,e){i.update(e)}const nn={};document.addEventListener("keydown",i=>{nn[i.code]=!0}),document.addEventListener("keyup",i=>{nn[i.code]=!1});function _m(){document.getElementById("go-btn").addEventListener("click",()=>{window.restartGame&&window.restartGame()})}function xm(i,e,t){if(i.hp<=0||e.gameOver)return;const n=nn.KeyW||nn.ArrowUp,r=nn.KeyS||nn.ArrowDown,s=nn.KeyA||nn.ArrowLeft,a=nn.KeyD||nn.ArrowRight,o=nn.Space;n?i.speed+=18*t:r&&(i.speed>.5?i.speed-=25*t:i.speed-=8*t),o&&i.speed>0&&(i.speed-=75*t),i.speed=Math.max(-6,Math.min(55,i.speed)),Math.abs(i.speed)<.05&&(i.speed=0);const c=document.getElementById("junction-box");if(i.onBranch===-1&&i.nearJunction&&i.atJunction){if(c.classList.add("show"),s&&!i._branchTaken){const l=i.nearJunction.index;i.onBranch=l,i.branchProgress=0,i._branchTaken=!0,i.speed=Math.max(i.speed,20),c.classList.remove("show")}else if(a&&!i._branchTaken){const l=(i.nearJunction.index+1)%3;i.onBranch=l,i.branchProgress=0,i._branchTaken=!0,i.speed=Math.max(i.speed,20),c.classList.remove("show")}}else(!i.nearJunction||!i.atJunction)&&(c.classList.remove("show"),i._branchTaken=!1)}const Vt={gameOver:!1,score:0,stars:0,crashes:0,distance:0,speed:0,hp:100};let Cn,Va,Wc,fn,At,si=[],Ha,zr,Xc;function vm(){const i=am();Cn=i.scene,Va=i.camera,Wc=i.renderer,Xc=new Hh,fn=om(Cn),Ha=dm(Cn,fn),zr=gm(Cn),qc(),_m(),window.restartGame=Mm,Kc()}function qc(){At=hm(Cn),At.trackPos=0,At.speed=0,At.spawnProtected=!0,si=[];const i=fn.mainLen,e=[i*.15,i*.35,i*.55,i*.75];for(let t=0;t<e.length;t++){const n=um(Cn);n.trackPos=e[t],n.speed=12+Math.random()*6,n.baseSpeed=n.speed,si.push(n)}setTimeout(()=>{At.spawnProtected=!1},2e3)}function Mm(){Yc(At);for(const i of si)Yc(i);si=[],Vt.gameOver=!1,Vt.stars=0,Vt.crashes=0,Vt.distance=0,Vt.hp=100,document.getElementById("gameover").classList.remove("show"),qc()}function Yc(i){if(i){for(const e of i.cars)e.mesh&&Cn.remove(e.mesh);for(const e of i.couplers)e&&Cn.remove(e)}}function Kc(){var e,t;requestAnimationFrame(Kc);const i=Math.min(Xc.getDelta(),.05);if(!(i<=0)){if(Vt.gameOver)kc(zr,i);else{xm(At,Vt,i),Sm(At,fn),$c(At,i,!0);for(const r of si)$c(r,i,!1);Hc(At,fn);for(const r of si)Hc(r,fn);At.spawnProtected||fm(At,si,Vt,zr);const n=(t=(e=At.cars[0])==null?void 0:e.mesh)==null?void 0:t.position;n&&Ha.checkStars(n,Vt),Em(At,Va,i),Ha.update(i),kc(zr,i),Vt.distance=Math.floor(At.trackPos),Vt.speed=Math.round(Math.abs(At.speed*3.6)),Vt.hp=At.hp,pm(Vt)}Wc.render(Cn,Va)}}function Sm(i,e){if(i.onBranch>=0){i.nearJunction=null,i.atJunction=!1;return}const t=(i.trackPos%e.mainLen+e.mainLen)%e.mainLen;let n=-1,r=1/0;for(let s=0;s<e.junctions.length;s++){let o=e.junctions[s].entryDistance-t;o<0&&(o+=e.mainLen),o<r&&(r=o,n=s)}n>=0&&r<80?(i.nearJunction=Wr({index:n},e.junctions[n]),i.atJunction=r<18):(i.nearJunction=null,i.atJunction=!1)}function $c(i,e,t){if(i.hp<=0)return;i.speed*=Math.pow(.996,e*60),t||(i.speed+=(i.baseSpeed-i.speed)*e*.5),i.speed=Math.max(0,Math.min(i.speed,t?55:30));const n=i.speed*e;if(i.onBranch>=0){const r=fn.junctions[i.onBranch];if(r){const s=r.branchCurve.getLength();i.branchProgress+=n/s,i.branchProgress>=1&&(i.onBranch=-1,i.branchProgress=0,i.trackPos=r.exitDistance)}}else i.trackPos=((i.trackPos+n)%fn.mainLen+fn.mainLen)%fn.mainLen}let Gr=new P,Jc=new P,ka="third";document.addEventListener("keydown",i=>{i.code==="KeyV"&&(ka=ka==="third"?"top":"third")});function Em(i,e,t){var r;if(!((r=i==null?void 0:i.cars[0])!=null&&r.mesh))return;const n=i.cars[0].mesh.position;if(ka==="third"){const s=new P(0,0,1).applyQuaternion(i.cars[0].mesh.quaternion),a=n.clone().sub(s.clone().multiplyScalar(20));a.y+=8;const o=n.clone().add(s.clone().multiplyScalar(10));o.y+=1,Gr.lerp(a,Math.min(1,t*3)),Jc.lerp(o,Math.min(1,t*3)),e.position.copy(Gr),e.lookAt(Jc)}else{const s=n.clone();s.y+=40,Gr.lerp(s,Math.min(1,t*2)),e.position.copy(Gr),e.lookAt(n.x,0,n.z)}}vm()})();
